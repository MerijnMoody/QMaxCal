...
def run_torch_trajectories(evolution, n_samples=2000):
    ...
    for _ in range(n_samples):
        ...
        for state in result.state_trajectory:
            ...
            populations.append((state[1]*state[1].conj()).real)  # Extract |1⟩ population
...
def run_qutip_mcsolve(n_trajectories=2000):
